//! Pugspeak presets database.

//# feather use syntax-errors

/// Represents the set of environment presets understood by Pugspeak.
...
function __pugspeak_init_presets() {
    ...
    pugspeak_preset_add(PugspeakPreset.STRING, __pugspeak_preset_string);
    pugspeak_preset_add(PugspeakPreset.MATH, __pugspeak_preset_math);
    pugspeak_preset_add(PugspeakPreset.MATH_3D, __pugspeak_preset_math_3d);
    pugspeak_preset_add(PugspeakPreset.COLOUR, __pugspeak_preset_colour);
    pugspeak_preset_add(PugspeakPreset.DRAW, __pugspeak_preset_draw);
    pugspeak_preset_add(PugspeakPreset.RANDOM, __pugspeak_preset_random);
    pugspeak_preset_add(PugspeakPreset.UNSAFE, __pugspeak_preset_unsafe);
}